...
static stmt_ty iterator_def_rule(Parser *p);
...
static stmt_ty trait_def_raw_rule(Parser *p, asdl_expr_seq* decorators_p);
...
file_rule(Parser *p)
{
    ...
    { // statements? $
        ...
        if (
            ...
            &&
            (endmarker_var = _Mys_PyPegen_expect_token(p, ENDMARKER))  // token='ENDMARKER'
        )
        {
            D(fprintf(stderr, "%*c+ file[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "statements? $"));
            _res = _Mys_PyPegen_make_module ( p , a );
...
interactive_rule(Parser *p)
{
    ...
    { // statement_newline
        ...
        )
        {
            ...
            _res = Mys_Interactive ( a , p -> arena );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
func_type_rule(Parser *p)
{
    ...
    { // '(' type_expressions? ')' '->' expression NEWLINE* $
        ...
        if (
            ...
            &&
            (_literal_2 = _Mys_PyPegen_expect_token(p, 51))  // token='->'
            &&
        ...
        )
        {
            ...
            _res = Mys_FunctionType ( a , b , p -> arena );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
type_expressions_rule(Parser *p)
{
    ...
    { // ','.expression+ ',' '*' expression ',' '**' expression
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 12))  // token=','
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 16))  // token='*'
            &&
            (b = expression_rule(p))  // expression
            &&
            (_literal_2 = _Mys_PyPegen_expect_token(p, 12))  // token=','
            &&
            (_literal_3 = _Mys_PyPegen_expect_token(p, 35))  // token='**'
            &&
            (c = expression_rule(p))  // expression
        )
        {
            D(fprintf(stderr, "%*c+ type_expressions[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.expression+ ',' '*' expression ',' '**' expression"));
            _res = ( asdl_expr_seq * ) _Mys_PyPegen_seq_append_to_end ( p , CHECK ( asdl_seq * , _Mys_PyPegen_seq_append_to_end ( p , a , b ) ) , c );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // ','.expression+ ',' '*' expression
        ...
        {
            D(fprintf(stderr, "%*c+ type_expressions[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.expression+ ',' '*' expression"));
            _res = ( asdl_expr_seq * ) _Mys_PyPegen_seq_append_to_end ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // ','.expression+ ',' '**' expression
        ...
        if (
            ...
            (_literal = _Mys_PyPegen_expect_token(p, 12))  // token=','
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 35))  // token='**'
            &&
            (b = expression_rule(p))  // expression
        )
        {
    ...
    { // '*' expression ',' '**' expression
        ...
        expr_ty b;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 16))  // token='*'
            &&
            (a = expression_rule(p))  // expression
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 12))  // token=','
            &&
            (_literal_2 = _Mys_PyPegen_expect_token(p, 35))  // token='**'
            &&
            (b = expression_rule(p))  // expression
        )
        {
            D(fprintf(stderr, "%*c+ type_expressions[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'*' expression ',' '**' expression"));
            _res = ( asdl_expr_seq * ) _Mys_PyPegen_seq_append_to_end ( p , CHECK ( asdl_seq * , _Mys_PyPegen_singleton_seq ( p , a ) ) , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '*' expression
        ...
        {
            D(fprintf(stderr, "%*c+ type_expressions[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'*' expression"));
            _res = ( asdl_expr_seq * ) _Mys_PyPegen_singleton_seq ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '**' expression
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 35))  // token='**'
            &&
            (a = expression_rule(p))  // expression
        )
        {
...
statements_rule(Parser *p)
{
    ...
    { // statement+
        ...
        )
        {
            ...
            _res = ( asdl_stmt_seq * ) _Mys_PyPegen_seq_flatten ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
statement_rule(Parser *p)
{
    ...
    { // compound_stmt
        ...
        )
        {
            ...
            _res = ( asdl_stmt_seq * ) _Mys_PyPegen_singleton_seq ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
statement_newline_rule(Parser *p)
{
    ...
    { // compound_stmt NEWLINE
        ...
        if (
            (a = compound_stmt_rule(p))  // compound_stmt
            &&
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
    ...
    { // NEWLINE
        ...
        )
        {
            ...
            _res = ( asdl_stmt_seq * ) _Mys_PyPegen_singleton_seq ( p , CHECK ( stmt_ty , _Mys_Py_Pass ( EXTRA ) ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // $
        ...
        {
            D(fprintf(stderr, "%*c+ statement_newline[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "$"));
            _res = _Mys_PyPegen_interactive_exit ( p );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
simple_stmt_rule(Parser *p)
{
    ...
    { // small_stmt !';' NEWLINE
        ...
        if (
            ...
            &&
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, 13)  // token=';'
            &&
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
    ...
    { // ';'.small_stmt+ ';'? NEWLINE
        ...
        if (
            ...
            &&
            (_opt_var = _Mys_PyPegen_expect_token(p, 13), 1)  // ';'?
            &&
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
...
small_stmt_rule(Parser *p)
{
    ...
    stmt_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, small_stmt_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // &'return' return_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 500)  // token='return'
            &&
    ...
    { // &('import' | 'from') import_stmt
        ...
        if (
            _Mys_PyPegen_lookahead(1, _tmp_14_rule, p)
            &&
    ...
    { // &'raise' raise_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 501)  // token='raise'
            &&
    ...
    { // 'pass'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 502))  // token='pass'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'pass'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // &'del' del_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 503)  // token='del'
            &&
    ...
    { // &'yield' yield_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 504)  // token='yield'
            &&
    ...
    { // &'assert' assert_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 505)  // token='assert'
            &&
    ...
    { // 'break'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 506))  // token='break'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'break'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // 'continue'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 507))  // token='continue'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'continue'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // &'global' global_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 508)  // token='global'
            &&
    ...
    { // &'nonlocal' nonlocal_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 509)  // token='nonlocal'
            &&
    ...
    _Mys_PyPegen_insert_memo(p, _mark, small_stmt_type, _res);
    D(p->level--);
    return _res;
}
...
compound_stmt_rule(Parser *p)
{
    ...
    { // &('func' | '@') function_def
        ...
        D(fprintf(stderr, "%*c> compound_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "&('func' | '@') function_def"));
        stmt_ty function_def_var;
        if (
            _Mys_PyPegen_lookahead(1, _tmp_15_rule, p)
            &&
        ...
        D(fprintf(stderr, "%*c%s compound_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "&('func' | '@') function_def"));
    }
    { // &'if' if_stmt
        if (p->error_indicator) {
            D(p->level--);
        ...
        stmt_ty if_stmt_var;
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 510)  // token='if'
            &&
    ...
    { // &('class' | '@') class_def
        ...
        if (
            _Mys_PyPegen_lookahead(1, _tmp_16_rule, p)
            &&
    ...
    { // &('for') for_stmt
        ...
        if (
            _Mys_PyPegen_lookahead(1, _tmp_18_rule, p)
            &&
    ...
    { // &'try' try_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 511)  // token='try'
            &&
    ...
    { // &'while' while_stmt
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 512)  // token='while'
            &&
...
assignment_rule(Parser *p)
{
    ...
    { // NAME ':' expression ['=' annotated_rhs]
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = CHECK_VERSION ( stmt_ty , 6 , "Variable annotation syntax is" , _Mys_Py_AnnAssign ( CHECK ( expr_ty , _Mys_PyPegen_set_expr_context ( p , a , Store ) ) , b , c , 1 , EXTRA ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // ('(' single_target ')' | single_subscript_attribute_target) ':' expression ['=' annotated_rhs]
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = CHECK_VERSION ( stmt_ty , 6 , "Variable annotations syntax is" , _Mys_Py_AnnAssign ( a , b , c , 0 , EXTRA ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // ((star_targets '='))+ (yield_expr | star_expressions) !'=' TYPE_COMMENT?
        ...
        if (
            ...
            &&
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, 22)  // token='='
            &&
            (tc = _Mys_PyPegen_expect_token(p, TYPE_COMMENT), 1)  // TYPE_COMMENT?
        )
        {
            D(fprintf(stderr, "%*c+ assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "((star_targets '='))+ (yield_expr | star_expressions) !'=' TYPE_COMMENT?"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Assign ( a , b , NEW_TYPE_COMMENT ( p , tc ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // single_target augassign ~ (yield_expr | star_expressions)
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_AugAssign ( a , b -> kind , c , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
augassign_rule(Parser *p)
{
    ...
    { // '+='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 36))  // token='+='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'+='"));
            _res = _Mys_PyPegen_augoperator ( p , Add );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '-='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 37))  // token='-='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'-='"));
            _res = _Mys_PyPegen_augoperator ( p , Sub );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '*='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 38))  // token='*='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'*='"));
            _res = _Mys_PyPegen_augoperator ( p , Mult );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '@='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 50))  // token='@='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'@='"));
            _res = CHECK_VERSION ( AugOperator * , 5 , "The '@' operator is" , _Mys_PyPegen_augoperator ( p , MatMult ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '/='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 39))  // token='/='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'/='"));
            _res = _Mys_PyPegen_augoperator ( p , Div );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '%='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 40))  // token='%='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'%='"));
            _res = _Mys_PyPegen_augoperator ( p , Mod );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '&='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 41))  // token='&='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'&='"));
            _res = _Mys_PyPegen_augoperator ( p , BitAnd );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '|='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 42))  // token='|='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'|='"));
            _res = _Mys_PyPegen_augoperator ( p , BitOr );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '^='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 43))  // token='^='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'^='"));
            _res = _Mys_PyPegen_augoperator ( p , BitXor );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '<<='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 44))  // token='<<='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'<<='"));
            _res = _Mys_PyPegen_augoperator ( p , LShift );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '>>='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 45))  // token='>>='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'>>='"));
            _res = _Mys_PyPegen_augoperator ( p , RShift );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '**='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 46))  // token='**='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'**='"));
            _res = _Mys_PyPegen_augoperator ( p , Pow );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '//='
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 48))  // token='//='
        )
        {
            D(fprintf(stderr, "%*c+ augassign[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'//='"));
            _res = _Mys_PyPegen_augoperator ( p , FloorDiv );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
global_stmt_rule(Parser *p)
{
    ...
    { // 'global' ','.NAME+
        ...
        asdl_expr_seq* a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 508))  // token='global'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Global ( CHECK ( asdl_identifier_seq * , _Mys_PyPegen_map_names_to_ids ( p , a ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
nonlocal_stmt_rule(Parser *p)
{
    ...
    { // 'nonlocal' ','.NAME+
        ...
        asdl_expr_seq* a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 509))  // token='nonlocal'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Nonlocal ( CHECK ( asdl_identifier_seq * , _Mys_PyPegen_map_names_to_ids ( p , a ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
assert_stmt_rule(Parser *p)
{
    ...
    { // 'assert' expression [',' expression]
        ...
        void *b;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 505))  // token='assert'
            &&
            (a = expression_rule(p))  // expression
            &&
...
del_stmt_rule(Parser *p)
{
    ...
    { // 'del' del_targets &(';' | NEWLINE)
        ...
        asdl_expr_seq* a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 503))  // token='del'
            &&
            (a = del_targets_rule(p))  // del_targets
            &&
            _Mys_PyPegen_lookahead(1, _tmp_30_rule, p)
        )
        {
...
import_name_rule(Parser *p)
{
    ...
    { // 'import' dotted_as_names
        ...
        asdl_alias_seq* a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 513))  // token='import'
            &&
...
import_from_rule(Parser *p)
{
    ...
    { // 'from' (('.' | '...'))* dotted_name 'import' import_from_targets
        ...
        asdl_alias_seq* c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 514))  // token='from'
            &&
            (a = _loop0_31_rule(p))  // (('.' | '...'))*
            &&
            (b = dotted_name_rule(p))  // dotted_name
            &&
            (_keyword_1 = _Mys_PyPegen_expect_token(p, 513))  // token='import'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_ImportFrom ( b -> v . Name . id , c , _Mys_PyPegen_seq_count_dots ( a ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // 'from' (('.' | '...'))+ 'import' import_from_targets
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_ImportFrom ( NULL , b , _Mys_PyPegen_seq_count_dots ( a ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
import_from_targets_rule(Parser *p)
{
    ...
    { // '(' import_from_as_names ','? ')'
        ...
        if (
            ...
            &&
            (_opt_var = _Mys_PyPegen_expect_token(p, 12), 1)  // ','?
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 8))  // token=')'
        )
        {
    ...
    { // import_from_as_names !','
        ...
        if (
            ...
            &&
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, 12)  // token=','
        )
        {
            D(fprintf(stderr, "%*c+ import_from_targets[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "import_from_as_names !','"));
    ...
    { // '*'
        ...
        {
            D(fprintf(stderr, "%*c+ import_from_targets[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'*'"));
            _res = ( asdl_alias_seq * ) _Mys_PyPegen_singleton_seq ( p , CHECK ( alias_ty , _Mys_PyPegen_alias_for_star ( p ) ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
import_from_as_name_rule(Parser *p)
{
    ...
    { // NAME ['as' NAME]
        ...
        )
        {
            ...
            _res = _Mys_Py_alias ( a -> v . Name . id , ( b ) ? ( ( expr_ty ) b ) -> v . Name . id : NULL , p -> arena );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
dotted_name_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, dotted_name_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_0 = _Mys_PyPegen_update_memo(p, _mark, dotted_name_type, _res);
        if (tmpvar_0) {
            D(p->level--);
            return _res;
        }
...
dotted_name_raw(Parser *p)
{
    ...
    { // dotted_name '.' NAME
        ...
        if (
            (a = dotted_name_rule(p))  // dotted_name
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 23))  // token='.'
            &&
            (b = _Mys_PyPegen_name_token(p))  // NAME
        )
        {
            D(fprintf(stderr, "%*c+ dotted_name[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "dotted_name '.' NAME"));
            _res = _Mys_PyPegen_join_names_with_dot ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
if_stmt_rule(Parser *p)
{
    ...
    { // 'if' named_expression ':' block elif_stmt
        ...
        stmt_ty c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 510))  // token='if'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_If ( a , b , CHECK ( asdl_stmt_seq * , _Mys_PyPegen_singleton_seq ( p , c ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
elif_stmt_rule(Parser *p)
{
    ...
    { // 'elif' named_expression ':' block elif_stmt
        ...
        stmt_ty c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 515))  // token='elif'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 11))  // token=':'
...
else_block_rule(Parser *p)
{
    ...
    { // 'else' ':' block
        ...
        asdl_stmt_seq* b;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 516))  // token='else'
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
...
while_stmt_rule(Parser *p)
{
    ...
    { // 'while' named_expression ':' block else_block?
        ...
        void *c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 512))  // token='while'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 11))  // token=':'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_While ( a , b , c , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
for_stmt_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' ~ star_expressions ':' TYPE_COMMENT? block else_block?
        ...
        void *tc;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 517))  // token='for'
            &&
            (t = star_targets_rule(p))  // star_targets
            &&
            (_keyword_1 = _Mys_PyPegen_expect_token(p, 518))  // token='in'
            &&
            (_cut_var = 1)
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_For ( t , ex , b , el , NEW_TYPE_COMMENT ( p , tc ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block finally_block
        ...
        asdl_stmt_seq* f;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 511))  // token='try'
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Try ( b , NULL , NULL , f , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // 'try' ':' block except_block+ else_block? finally_block?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Try ( b , ex , el , f , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
except_block_rule(Parser *p)
{
    ...
    { // 'except' expression ['as' NAME] ':' block
        ...
        void *t;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 521))  // token='except'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_ExceptHandler ( e , ( t ) ? ( ( expr_ty ) t ) -> v . Name . id : NULL , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // 'except' ':' block
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_ExceptHandler ( NULL , NULL , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
finally_block_rule(Parser *p)
{
    ...
    { // 'finally' ':' block
        ...
        asdl_stmt_seq* a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 522))  // token='finally'
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 11))  // token=':'
            &&
...
match_stmt_rule(Parser *p)
{
    ...
    { // "match" subject_expr ':' NEWLINE INDENT case_block+ DEDENT
        ...
        expr_ty subject;
        if (
            (_keyword = _Mys_PyPegen_expect_soft_keyword(p, "match"))  // soft_keyword='"match"'
            &&
            ...
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (indent_var = _Mys_PyPegen_expect_token(p, INDENT))  // token='INDENT'
            &&
            (cases = (asdl_match_case_seq*)_loop1_50_rule(p))  // case_block+
            &&
            (dedent_var = _Mys_PyPegen_expect_token(p, DEDENT))  // token='DEDENT'
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = CHECK_VERSION ( stmt_ty , 6 , "Pattern matching is" , _Mys_Py_Match ( subject , cases , EXTRA ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
subject_expr_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_seq_insert_in_front ( p , value , values ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
case_block_rule(Parser *p)
{
    ...
    { // "case" patterns guard? ':' block
        ...
        expr_ty pattern;
        if (
            (_keyword = _Mys_PyPegen_expect_soft_keyword(p, "case"))  // soft_keyword='"case"'
            &&
        ...
        )
        {
            ...
            _res = _Mys_Py_match_case ( pattern , guard , body , p -> arena );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
patterns_rule(Parser *p)
{
    ...
    { // open_sequence_pattern
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( values , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
as_pattern_rule(Parser *p)
{
    ...
    { // or_pattern 'as' capture_pattern
        ...
        if (
            ...
            &&
            (_keyword = _Mys_PyPegen_expect_token(p, 520))  // token='as'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_MatchAs ( pattern , target -> v . Name . id , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
or_pattern_rule(Parser *p)
{
    ...
    { // '|'.closed_pattern+
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = Mys_asdl_seq_LEN ( patterns ) == 1 ? Mys_asdl_seq_GET ( patterns , 0 ) : _Mys_Py_MatchOr ( patterns , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
literal_pattern_rule(Parser *p)
{
    ...
    { // signed_number !('+' | '-')
        ...
        if (
            ...
            &&
            _Mys_PyPegen_lookahead(0, _tmp_53_rule, p)
        )
        {
    ...
    { // signed_number '+' NUMBER
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 14))  // token='+'
            &&
            (imag = _Mys_PyPegen_number_token(p))  // NUMBER
        )
        {
            D(fprintf(stderr, "%*c+ literal_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "signed_number '+' NUMBER"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( real , Add , imag , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // signed_number '-' NUMBER
        ...
        if (
            (real = signed_number_rule(p))  // signed_number
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 15))  // token='-'
            &&
            (imag = _Mys_PyPegen_number_token(p))  // NUMBER
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( real , Sub , imag , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // 'None'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 523))  // token='None'
        )
        {
            D(fprintf(stderr, "%*c+ literal_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'None'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // 'True'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 524))  // token='True'
        )
        {
            D(fprintf(stderr, "%*c+ literal_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'True'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Constant ( Py_True , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // 'False'
        ...
        Token * _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 525))  // token='False'
        )
        {
            D(fprintf(stderr, "%*c+ literal_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'False'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
...
signed_number_rule(Parser *p)
{
    ...
    { // NUMBER
        ...
        expr_ty number_var;
        if (
            (number_var = _Mys_PyPegen_number_token(p))  // NUMBER
        )
        {
    ...
    { // '-' NUMBER
        ...
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 15))  // token='-'
            &&
            (number = _Mys_PyPegen_number_token(p))  // NUMBER
        )
        {
            D(fprintf(stderr, "%*c+ signed_number[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'-' NUMBER"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_UnaryOp ( USub , number , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
capture_pattern_rule(Parser *p)
{
    ...
    { // !"_" NAME !('.' | '(' | '=')
        ...
        expr_ty name;
        if (
            _Mys_PyPegen_lookahead_with_string(0, _Mys_PyPegen_expect_soft_keyword, p, "_")
            &&
            (name = _Mys_PyPegen_name_token(p))  // NAME
            &&
            _Mys_PyPegen_lookahead(0, _tmp_54_rule, p)
        )
        {
            D(fprintf(stderr, "%*c+ capture_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "!\"_\" NAME !('.' | '(' | '=')"));
            _res = _Mys_PyPegen_set_expr_context ( p , name , Store );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
wildcard_pattern_rule(Parser *p)
{
    ...
    { // "_"
        ...
        expr_ty _keyword;
        if (
            (_keyword = _Mys_PyPegen_expect_soft_keyword(p, "_"))  // soft_keyword='"_"'
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Name ( CHECK ( PyObject * , _Mys_PyPegen_new_identifier ( p , "_" ) ) , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
value_pattern_rule(Parser *p)
{
    ...
    { // attr !('.' | '(' | '=')
        ...
        if (
            ...
            &&
            _Mys_PyPegen_lookahead(0, _tmp_55_rule, p)
        )
        {
...
attr_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, attr_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_1 = _Mys_PyPegen_update_memo(p, _mark, attr_type, _res);
        if (tmpvar_1) {
            D(p->level--);
            return _res;
        }
...
attr_raw(Parser *p)
{
    ...
    { // name_or_attr '.' NAME
        ...
        if (
            ...
            (_literal = _Mys_PyPegen_expect_token(p, 23))  // token='.'
            &&
            (attr = _Mys_PyPegen_name_token(p))  // NAME
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Attribute ( value , attr -> v . Name . id , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
sequence_pattern_rule(Parser *p)
{
    ...
    { // '[' maybe_sequence_pattern? ']'
        ...
        void *values;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 9))  // token='['
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_List ( values , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
open_sequence_pattern_rule(Parser *p)
{
    ...
    { // maybe_star_pattern ',' maybe_sequence_pattern?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_seq_insert_in_front ( p , value , values );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
star_pattern_rule(Parser *p)
{
    ...
    { // '*' (capture_pattern | wildcard_pattern)
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Starred ( value , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
mapping_pattern_rule(Parser *p)
{
    ...
    { // '{' items_pattern? '}'
        ...
        void *items;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 25))  // token='{'
            &&
            (items = items_pattern_rule(p), 1)  // items_pattern?
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 26))  // token='}'
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Dict ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_get_keys ( p , items ) ) , CHECK ( asdl_expr_seq * , _Mys_PyPegen_get_values ( p , items ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
key_value_pattern_rule(Parser *p)
{
    ...
    { // (literal_pattern | value_pattern) ':' pattern
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_key_value_pair ( p , key , value );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
double_star_pattern_rule(Parser *p)
{
    ...
    { // '**' capture_pattern
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_key_value_pair ( p , NULL , value );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
class_pattern_rule(Parser *p)
{
    ...
    { // name_or_attr '(' ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( func , NULL , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // name_or_attr '(' positional_patterns ','? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( func , args , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // name_or_attr '(' keyword_patterns ','? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( func , NULL , keywords , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // name_or_attr '(' positional_patterns ',' keyword_patterns ','? ')'
        ...
        if (
            ...
            (_opt_var = _Mys_PyPegen_expect_token(p, 12), 1)  // ','?
            &&
            (_literal_2 = _Mys_PyPegen_expect_token(p, 8))  // token=')'
        )
        {
            D(fprintf(stderr, "%*c+ class_pattern[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "name_or_attr '(' positional_patterns ',' keyword_patterns ','? ')'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( func , args , keywords , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
keyword_pattern_rule(Parser *p)
{
    ...
    { // NAME '=' pattern
        ...
        expr_ty value;
        if (
            (arg = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 22))  // token='='
            &&
            (value = pattern_rule(p))  // pattern
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_keyword ( arg -> v . Name . id , value , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
return_stmt_rule(Parser *p)
{
    ...
    { // 'return' star_expressions?
        ...
        void *a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 500))  // token='return'
            &&
...
raise_stmt_rule(Parser *p)
{
    ...
    { // 'raise' expression ['from' expression]
        ...
        void *b;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 501))  // token='raise'
            &&
            (a = expression_rule(p))  // expression
            &&
    ...
    { // 'raise'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Raise ( NULL , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
function_def_rule(Parser *p)
{
    ...
    { // decorators function_def_raw
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_function_def_decorators ( p , d , f );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // macro_def
        ...
        D(fprintf(stderr, "%*c> macro_def[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "macro_def"));
        stmt_ty macro_def_var;
        if (
            (macro_def_var = macro_def_rule(p))  // macro_def
        )
        {
            D(fprintf(stderr, "%*c+ macro_def[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "macro_def"));
            _res = macro_def_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s macro_def[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "macro_def"));
    }
    { // iterator_def
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> iterator_def[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "iterator_def"));
        stmt_ty iterator_def_var;
        if (
            (iterator_def_var = iterator_def_rule(p))  // iterator_def
        )
        {
            D(fprintf(stderr, "%*c+ iterator_def[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "iterator_def"));
            _res = iterator_def_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s iterator_def[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "iterator_def"));
    }
    { // test_def
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> test_def[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "test_def"));
        stmt_ty test_def_var;
        if (
            (test_def_var = test_def_rule(p))  // test_def
        )
        {
            D(fprintf(stderr, "%*c+ test_def[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "test_def"));
            _res = test_def_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s test_def[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "test_def"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// function_def_raw:
//     | 'func' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
static stmt_ty
function_def_raw_rule(Parser *p)
{
    ...
    { // 'func' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        if (
            ...
            &&
            (n = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 7))  // token='('
            &&
...
// macro_def:
//     | 'macro' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
static stmt_ty
macro_def_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // 'func' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        void *tc;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 10002))  // token='macro'
            &&
            (n = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 7))  // token='('
        ...
        )
        {
            ...
            PyObject *id = _Mys_PyPegen_new_identifier(p, "macro");
            if (id == NULL) {
                p->error_indicator = 1;
                PyErr_NoMemory();
                D(p->level--);
...
// iterator_def:
//     | 'iterator' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
static stmt_ty
iterator_def_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    int _start_lineno = p->tokens[_mark]->lineno;
    UNUSED(_start_lineno); // Only used by EXTRA iterator
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA iterator
    { // 'func' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        ...
        void *tc;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 10004))  // token='iterator'
            &&
            (n = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 7))  // token='('
        ...
        )
        {
            ...
            int _end_lineno = _token->end_lineno;
            UNUSED(_end_lineno); // Only used by EXTRA iterator
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA iterator
            _res = _Mys_Py_FunctionDef ( n -> v . Name . id , ( params ) ? params : CHECK ( arguments_ty , _Mys_PyPegen_empty_arguments ( p ) ) , b , NULL , a , NEW_TYPE_COMMENT ( p , tc ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
            ...
            PyObject *id = _Mys_PyPegen_new_identifier(p, "iterator");
            if (id == NULL) {
                p->error_indicator = 1;
                PyErr_NoMemory();
                D(p->level--);
...
// test_def:
//     | 'test' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
static stmt_ty
test_def_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // 'test' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        void *tc;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 10003))  // token='test'
            &&
            (n = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 7))  // token='('
        ...
        )
        {
            ...
            PyObject *id = _Mys_PyPegen_new_identifier(p, "test");
            if (id == NULL) {
                p->error_indicator = 1;
                PyErr_NoMemory();
                D(p->level--);
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE INDENT)
        ...
        if (
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (t = _Mys_PyPegen_expect_token(p, TYPE_COMMENT))  // token='TYPE_COMMENT'
            &&
            _Mys_PyPegen_lookahead(1, _tmp_69_rule, p)
        )
        {
    ...
    { // TYPE_COMMENT
        ...
        if (
            (type_comment_var = _Mys_PyPegen_expect_token(p, TYPE_COMMENT))  // token='TYPE_COMMENT'
        )
        {
            D(fprintf(stderr, "%*c+ func_type_comment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "TYPE_COMMENT"));
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_make_arguments ( p , a , NULL , b , c , d );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // slash_with_default param_with_default* star_etc?
        ...
        {
            D(fprintf(stderr, "%*c+ parameters[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "slash_with_default param_with_default* star_etc?"));
            _res = _Mys_PyPegen_make_arguments ( p , NULL , a , NULL , b , c );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // param_no_default+ param_with_default* star_etc?
        ...
        {
            D(fprintf(stderr, "%*c+ parameters[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_no_default+ param_with_default* star_etc?"));
            _res = _Mys_PyPegen_make_arguments ( p , NULL , NULL , a , b , c );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // param_with_default+ star_etc?
        ...
        {
            D(fprintf(stderr, "%*c+ parameters[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+ star_etc?"));
            _res = _Mys_PyPegen_make_arguments ( p , NULL , NULL , NULL , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // star_etc
        ...
        {
            D(fprintf(stderr, "%*c+ parameters[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_etc"));
            _res = _Mys_PyPegen_make_arguments ( p , NULL , NULL , NULL , NULL , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
slash_no_default_rule(Parser *p)
{
    ...
    { // param_no_default+ '/' ','
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 17))  // token='/'
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 12))  // token=','
        )
        {
    ...
    { // param_no_default+ '/' &')'
        ...
        if (
            ...
            (_literal = _Mys_PyPegen_expect_token(p, 17))  // token='/'
            &&
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 8)  // token=')'
        )
        {
            D(fprintf(stderr, "%*c+ slash_no_default[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_no_default+ '/' &')'"));
            _res = a;
...
slash_with_default_rule(Parser *p)
{
    ...
    { // param_no_default* param_with_default+ '/' ','
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_slash_with_default ( p , ( asdl_arg_seq * ) a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_star_etc ( p , a , b , c );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        {
            D(fprintf(stderr, "%*c+ star_etc[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'*' ',' param_maybe_default+ kwds?"));
            _res = _Mys_PyPegen_star_etc ( p , NULL , b , c );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // kwds
        ...
        {
            D(fprintf(stderr, "%*c+ star_etc[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "kwds"));
            _res = _Mys_PyPegen_star_etc ( p , NULL , NULL , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
param_no_default_rule(Parser *p)
{
    ...
    { // param ',' TYPE_COMMENT?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_add_type_comment_to_arg ( p , a , tc );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
param_with_default_rule(Parser *p)
{
    ...
    { // param default ',' TYPE_COMMENT?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_name_default_pair ( p , a , c , tc );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
param_rule(Parser *p)
{
    ...
    { // NAME annotation?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_arg ( a -> v . Name . id , b , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
class_def_rule(Parser *p)
{
    ...
    { // decorators class_def_raw
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_class_def_decorators ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // decorators trait_def_raw
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> trait_def[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "decorators trait_def_raw"));
        asdl_expr_seq* a;
        stmt_ty b;
        if (
            (a = decorators_rule(p))  // decorators
            &&
            (b = trait_def_raw_rule(p, a))  // trait_def_raw
        )
        {
            D(fprintf(stderr, "%*c+ trait_def[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "decorators trait_def_raw"));
            _res = b;
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s trait_def[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "decorators trait_def_raw"));
    }
    { // class_def_raw
        if (p->error_indicator) {
            D(p->level--);
    ...
    { // trait_def_raw
        ...
        D(fprintf(stderr, "%*c> trait_def[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "trait_def"));
        stmt_ty trait_def_var;
        if (
            (trait_def_var = trait_def_raw_rule(p, NULL))  // trait_def
        )
        {
            D(fprintf(stderr, "%*c+ trait_def[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "trait_def"));
            _res = trait_def_var;
...
class_def_raw_rule(Parser *p)
{
    ...
    { // 'class' NAME ['(' arguments? ')'] ':' block
        ...
        asdl_stmt_seq* c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 527))  // token='class'
            &&
            (a = _Mys_PyPegen_name_token(p))  // NAME
            &&
...
// trait_def: 'trait' NAME ['(' arguments? ')'] ':' block
static stmt_ty
trait_def_raw_rule(Parser *p, asdl_expr_seq* decorators_p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // 'trait' NAME ['(' arguments? ')'] ':' block
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> trait_def_raw[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'trait' NAME ['(' arguments? ')'] ':' block"));
        Token * _keyword;
        Token * _literal;
        expr_ty a;
        void *b;
        ...
        {
            D(fprintf(stderr, "%*c+ trait_def_raw[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'trait' NAME ['(' arguments? ')'] ':' block"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            asdl_seq *_seq;
            if (decorators_p == NULL) {
                _seq = _Mys_PyPegen_singleton_seq(p, child);
            } else {
                _seq = _Mys_PyPegen_seq_append_to_end(p,
                                                      (asdl_seq *)decorators_p,
                                                      child);
            }
            asdl_expr_seq* d;
            if (!_seq) {
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s trait_def_raw[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'trait' NAME ['(' arguments? ')'] ':' block"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
block_rule(Parser *p)
{
    ...
    asdl_stmt_seq* _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, block_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, block_type, _res);
    D(p->level--);
    return _res;
}
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_seq_insert_in_front ( p , a , b ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // star_expression ','
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_singleton_seq ( p , a ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
star_expression_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, star_expression_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // '*' bitwise_or
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Starred ( a , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, star_expression_type, _res);
    D(p->level--);
    return _res;
}
...
named_expression_rule(Parser *p)
{
    ...
    { // NAME ':=' ~ expression
        ...
        if (
            (a = _Mys_PyPegen_name_token(p))  // NAME
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 53))  // token=':='
            &&
            (_cut_var = 1)
            &&
            (b = expression_rule(p))  // expression
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_NamedExpr ( CHECK ( expr_ty , _Mys_PyPegen_set_expr_context ( p , a , Store ) ) , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // expression !':='
        ...
        if (
            (expression_var = expression_rule(p))  // expression
            &&
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, 53)  // token=':='
        )
        {
            D(fprintf(stderr, "%*c+ named_expression[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression !':='"));
            _res = expression_var;
...
expression_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, expression_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // disjunction 'if' disjunction 'else' expression
        ...
        if (
            ...
            &&
            (_keyword_1 = _Mys_PyPegen_expect_token(p, 516))  // token='else'
            &&
            (c = expression_rule(p))  // expression
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_IfExp ( b , a , c , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, expression_type, _res);
    D(p->level--);
    return _res;
}
...
lambdef_rule(Parser *p)
{
    ...
    { // 'lambda' lambda_params? ':' expression
        ...
        expr_ty b;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 528))  // token='lambda'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Lambda ( ( a ) ? a : CHECK ( arguments_ty , _Mys_PyPegen_empty_arguments ( p ) ) , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
lambda_slash_no_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default+ '/' &':'
        ...
        if (
            ...
            (_literal = _Mys_PyPegen_expect_token(p, 17))  // token='/'
            &&
            _Mys_PyPegen_lookahead_with_int(1, _Mys_PyPegen_expect_token, p, 11)  // token=':'
        )
        {
            D(fprintf(stderr, "%*c+ lambda_slash_no_default[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_no_default+ '/' &':'"));
            _res = a;
...
lambda_param_with_default_rule(Parser *p)
{
    ...
    { // lambda_param default ','
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_name_default_pair ( p , a , c , NULL );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
lambda_param_rule(Parser *p)
{
    ...
    { // NAME
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_arg ( a -> v . Name . id , NULL , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
disjunction_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, disjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // conjunction (('or' conjunction))+
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BoolOp ( Or , CHECK ( asdl_expr_seq * , _Mys_PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, disjunction_type, _res);
    D(p->level--);
    return _res;
}
...
conjunction_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, conjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // inversion (('and' inversion))+
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BoolOp ( And , CHECK ( asdl_expr_seq * , _Mys_PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, conjunction_type, _res);
    D(p->level--);
    return _res;
}
...
inversion_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, inversion_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // 'not' inversion
        ...
        expr_ty a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 529))  // token='not'
            &&
            (a = inversion_rule(p))  // inversion
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_UnaryOp ( Not , a , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, inversion_type, _res);
    D(p->level--);
    return _res;
}
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Compare ( a , CHECK ( asdl_int_seq * , _Mys_PyPegen_get_cmpops ( p , b ) ) , CHECK ( asdl_expr_seq * , _Mys_PyPegen_get_exprs ( p , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
eq_bitwise_or_rule(Parser *p)
{
    ...
    { // '==' bitwise_or
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 27))  // token='=='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ eq_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'==' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , Eq , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
noteq_bitwise_or_rule(Parser *p)
{
    ...
    { // ('!=') bitwise_or
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , NotEq , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
lte_bitwise_or_rule(Parser *p)
{
    ...
    { // '<=' bitwise_or
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 29))  // token='<='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ lte_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'<=' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , LtE , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
lt_bitwise_or_rule(Parser *p)
{
    ...
    { // '<' bitwise_or
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 20))  // token='<'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ lt_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'<' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , Lt , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
gte_bitwise_or_rule(Parser *p)
{
    ...
    { // '>=' bitwise_or
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 30))  // token='>='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ gte_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'>=' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , GtE , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
gt_bitwise_or_rule(Parser *p)
{
    ...
    { // '>' bitwise_or
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 21))  // token='>'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ gt_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'>' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , Gt , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
notin_bitwise_or_rule(Parser *p)
{
    ...
    { // 'not' 'in' bitwise_or
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , NotIn , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
in_bitwise_or_rule(Parser *p)
{
    ...
    { // 'in' bitwise_or
        ...
        expr_ty a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 518))  // token='in'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ in_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'in' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , In , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
isnot_bitwise_or_rule(Parser *p)
{
    ...
    { // 'is' 'not' bitwise_or
        ...
        expr_ty a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 530))  // token='is'
            &&
            (_keyword_1 = _Mys_PyPegen_expect_token(p, 529))  // token='not'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            D(fprintf(stderr, "%*c+ isnot_bitwise_or[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'is' 'not' bitwise_or"));
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , IsNot , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
is_bitwise_or_rule(Parser *p)
{
    ...
    { // 'is' bitwise_or
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_cmpop_expr_pair ( p , Is , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
bitwise_or_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, bitwise_or_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_2 = _Mys_PyPegen_update_memo(p, _mark, bitwise_or_type, _res);
        if (tmpvar_2) {
            D(p->level--);
            return _res;
        }
...
bitwise_or_raw(Parser *p)
{
    ...
    { // bitwise_or '|' bitwise_xor
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 18))  // token='|'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , BitOr , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
bitwise_xor_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, bitwise_xor_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_3 = _Mys_PyPegen_update_memo(p, _mark, bitwise_xor_type, _res);
        if (tmpvar_3) {
            D(p->level--);
            return _res;
        }
...
bitwise_xor_raw(Parser *p)
{
    ...
    { // bitwise_xor '^' bitwise_and
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 32))  // token='^'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , BitXor , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
bitwise_and_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, bitwise_and_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_4 = _Mys_PyPegen_update_memo(p, _mark, bitwise_and_type, _res);
        if (tmpvar_4) {
            D(p->level--);
            return _res;
        }
...
bitwise_and_raw(Parser *p)
{
    ...
    { // bitwise_and '&' shift_expr
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 19))  // token='&'
            &&
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , BitAnd , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
shift_expr_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, shift_expr_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_5 = _Mys_PyPegen_update_memo(p, _mark, shift_expr_type, _res);
        if (tmpvar_5) {
            D(p->level--);
            return _res;
        }
...
shift_expr_raw(Parser *p)
{
    ...
    { // shift_expr '<<' sum
        ...
        if (
            ...
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 33))  // token='<<'
            &&
            (b = sum_rule(p))  // sum
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , LShift , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // shift_expr '>>' sum
        ...
        if (
            (a = shift_expr_rule(p))  // shift_expr
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 34))  // token='>>'
            &&
            (b = sum_rule(p))  // sum
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , RShift , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
sum_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, sum_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_6 = _Mys_PyPegen_update_memo(p, _mark, sum_type, _res);
        if (tmpvar_6) {
            D(p->level--);
            return _res;
        }
...
sum_raw(Parser *p)
{
    ...
    { // sum '+' term
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Add , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // sum '-' term
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Sub , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
term_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, term_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_7 = _Mys_PyPegen_update_memo(p, _mark, term_type, _res);
        if (tmpvar_7) {
            D(p->level--);
            return _res;
        }
...
term_raw(Parser *p)
{
    ...
    { // term '*' factor
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Mult , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // term '/' factor
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Div , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // term '//' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 47))  // token='//'
            &&
            (b = factor_rule(p))  // factor
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , FloorDiv , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // term '%' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 24))  // token='%'
            &&
            (b = factor_rule(p))  // factor
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Mod , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // term '@' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (_literal = _Mys_PyPegen_expect_token(p, 49))  // token='@'
            &&
            (b = factor_rule(p))  // factor
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = CHECK_VERSION ( expr_ty , 5 , "The '@' operator is" , _Mys_Py_BinOp ( a , MatMult , b , EXTRA ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
factor_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, factor_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // '+' factor
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_UnaryOp ( UAdd , a , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '-' factor
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_UnaryOp ( USub , a , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '~' factor
        ...
        expr_ty a;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 31))  // token='~'
            &&
            (a = factor_rule(p))  // factor
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_UnaryOp ( Invert , a , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, factor_type, _res);
    D(p->level--);
    return _res;
}
...
power_rule(Parser *p)
{
    ...
    { // await_primary '**' factor
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_BinOp ( a , Pow , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
await_primary_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, await_primary_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, await_primary_type, _res);
    D(p->level--);
    return _res;
}
...
primary_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, primary_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_8 = _Mys_PyPegen_update_memo(p, _mark, primary_type, _res);
        if (tmpvar_8) {
            D(p->level--);
            return _res;
        }
...
primary_raw(Parser *p)
{
    ...
    { // primary '.' NAME
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Attribute ( a , b -> v . Name . id , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // primary genexp
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( a , CHECK ( asdl_expr_seq * , ( asdl_expr_seq * ) _Mys_PyPegen_singleton_seq ( p , b ) ) , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // primary '(' arguments? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( a , ( b ) ? ( ( expr_ty ) b ) -> v . Call . args : NULL , ( b ) ? ( ( expr_ty ) b ) -> v . Call . keywords : NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // primary '[' slices ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Subscript ( a , b , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
slices_rule(Parser *p)
{
    ...
    { // ','.slice+ ','?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( a , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
slice_rule(Parser *p)
{
    ...
    { // expression? ':' expression? [':' expression?]
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Slice ( a , b , c , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
atom_rule(Parser *p)
{
    ...
    { // &STRING strings
        ...
        expr_ty strings_var;
        if (
            _Mys_PyPegen_lookahead(1, _Mys_PyPegen_string_token, p)
            &&
            (strings_var = strings_rule(p))  // strings
        )
        {
    ...
    { // '...'
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 52))  // token='...'
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'...'"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Constant ( Py_Ellipsis , NULL , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
strings_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, strings_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    { // STRING+
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_concatenate_strings ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, strings_type, _res);
    D(p->level--);
    return _res;
}
...
list_rule(Parser *p)
{
    ...
    { // '[' star_named_expressions? ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_List ( a , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
listcomp_rule(Parser *p)
{
    ...
    { // '[' named_expression ~ for_if_clauses ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_ListComp ( a , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
genexp_rule(Parser *p)
{
    ...
    { // '(' expression ~ for_if_clauses ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_GeneratorExp ( a , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
setcomp_rule(Parser *p)
{
    ...
    { // '{' expression ~ for_if_clauses '}'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_SetComp ( a , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
dict_rule(Parser *p)
{
    ...
    { // '{' double_starred_kvpairs? '}'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Dict ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_get_keys ( p , a ) ) , CHECK ( asdl_expr_seq * , _Mys_PyPegen_get_values ( p , a ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
dictcomp_rule(Parser *p)
{
    ...
    { // '{' kvpair for_if_clauses '}'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_DictComp ( a -> key , a -> value , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
double_starred_kvpair_rule(Parser *p)
{
    ...
    { // '**' bitwise_or
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_key_value_pair ( p , NULL , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
kvpair_rule(Parser *p)
{
    ...
    { // expression ':' expression
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_key_value_pair ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
yield_expr_rule(Parser *p)
{
    ...
    { // 'yield' 'from' expression
        ...
        expr_ty a;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 504))  // token='yield'
            &&
            (_keyword_1 = _Mys_PyPegen_expect_token(p, 514))  // token='from'
            &&
            (a = expression_rule(p))  // expression
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_YieldFrom ( a , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
arguments_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, arguments_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, arguments_type, _res);
    D(p->level--);
    return _res;
}
...
args_rule(Parser *p)
{
    ...
    { // ','.(starred_expression | named_expression !'=')+ [',' kwargs]
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_PyPegen_collect_call_seqs ( p , a , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // kwargs
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Call ( _Mys_PyPegen_dummy_name ( p ) , CHECK_NULL_ALLOWED ( asdl_expr_seq * , _Mys_PyPegen_seq_extract_starred_exprs ( p , a ) ) , CHECK_NULL_ALLOWED ( asdl_keyword_seq * , _Mys_PyPegen_seq_delete_starred_exprs ( p , a ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_join_sequences ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
kwarg_or_starred_rule(Parser *p)
{
    ...
    { // NAME '=' expression
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_PyPegen_keyword_or_starred ( p , CHECK ( keyword_ty , _Mys_Py_keyword ( a -> v . Name . id , b , EXTRA ) ) , 1 );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // starred_expression
        ...
        {
            D(fprintf(stderr, "%*c+ kwarg_or_starred[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "starred_expression"));
            _res = _Mys_PyPegen_keyword_or_starred ( p , a , 0 );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
kwarg_or_double_starred_rule(Parser *p)
{
    ...
    { // '**' expression
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_PyPegen_keyword_or_starred ( p , CHECK ( keyword_ty , _Mys_Py_keyword ( NULL , a , EXTRA ) ) , 1 );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( CHECK ( asdl_expr_seq * , _Mys_PyPegen_seq_insert_in_front ( p , a , b ) ) , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
star_target_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, star_target_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // '*' (!'*' star_target)
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Starred ( CHECK ( expr_ty , _Mys_PyPegen_set_expr_context ( p , a , Store ) ) , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // t_primary '.' NAME !t_lookahead
        ...
        if (
            ...
            (b = _Mys_PyPegen_name_token(p))  // NAME
            &&
            _Mys_PyPegen_lookahead(0, t_lookahead_rule, p)
        )
        {
            D(fprintf(stderr, "%*c+ star_target[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "t_primary '.' NAME !t_lookahead"));
            Token *_token = _Mys_PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Attribute ( a , b -> v . Name . id , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // t_primary '[' slices ']' !t_lookahead
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Subscript ( a , b , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, star_target_type, _res);
    D(p->level--);
    return _res;
}
...
star_atom_rule(Parser *p)
{
    ...
    { // NAME
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_set_expr_context ( p , a , Store );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '(' star_targets_seq? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( a , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '[' star_targets_seq? ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_List ( a , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
del_target_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, del_target_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // t_primary '.' NAME !t_lookahead
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Attribute ( a , b -> v . Name . id , Del , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // t_primary '[' slices ']' !t_lookahead
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Subscript ( a , b , Del , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, del_target_type, _res);
    D(p->level--);
    return _res;
}
...
del_t_atom_rule(Parser *p)
{
    ...
    { // NAME
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_set_expr_context ( p , a , Del );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '(' del_targets? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( a , Del , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
target_rule(Parser *p)
{
    ...
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, target_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    _Mys_PyPegen_insert_memo(p, _mark, target_type, _res);
    D(p->level--);
    return _res;
}
...
t_primary_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_Mys_PyPegen_is_memoized(p, t_primary_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_9 = _Mys_PyPegen_update_memo(p, _mark, t_primary_type, _res);
        if (tmpvar_9) {
            D(p->level--);
            return _res;
        }
...
t_primary_raw(Parser *p)
{
    ...
    { // t_primary '.' NAME &t_lookahead
        ...
        if (
            ...
            (b = _Mys_PyPegen_name_token(p))  // NAME
            &&
            _Mys_PyPegen_lookahead(1, t_lookahead_rule, p)
        )
        {
...
t_atom_rule(Parser *p)
{
    ...
    { // '(' targets? ')'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_Tuple ( b , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // '[' targets? ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Mys_Py_List ( b , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
invalid_arguments_rule(Parser *p)
{
    ...
    { // args for_if_clauses
        ...
        {
            D(fprintf(stderr, "%*c+ invalid_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "args for_if_clauses"));
            _res = _Mys_PyPegen_nonparen_genexp_in_call ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // args ',' args
        ...
        {
            D(fprintf(stderr, "%*c+ invalid_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "args ',' args"));
            _res = _Mys_PyPegen_arguments_parsing_error ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
invalid_named_expression_rule(Parser *p)
{
    ...
    { // expression ':=' expression
        ...
        )
        {
            ...
            _res = RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "cannot use assignment expressions with %s" , _Mys_PyPegen_get_expr_name ( a ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // invalid_ann_assign_target ':' expression
        ...
        )
        {
            ...
            _res = RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "only single target (not %s) can be annotated" , _Mys_PyPegen_get_expr_name ( a ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            &&
            (_literal_1 = _Mys_PyPegen_expect_token(p, 11))  // token=':'
            &&
            (expression_var = expression_rule(p))  // expression
        )
        {
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
            _res = RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "'%s' is an illegal expression for augmented assignment" , _Mys_PyPegen_get_expr_name ( a ) );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
invalid_block_rule(Parser *p)
{
    ...
    { // NEWLINE !INDENT
        ...
        if (
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, INDENT)  // token=INDENT
        )
        {
...
invalid_primary_rule(Parser *p)
{
    ...
    { // primary '{'
        ...
        if (
            (primary_var = primary_rule(p))  // primary
            &&
            (a = _Mys_PyPegen_expect_token(p, 25))  // token='{'
        )
        {
...
invalid_dict_comprehension_rule(Parser *p)
{
    ...
    { // '{' '**' bitwise_or for_if_clauses '}'
        ...
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 25))  // token='{'
            &&
            (a = _Mys_PyPegen_expect_token(p, 35))  // token='**'
            &&
            (bitwise_or_var = bitwise_or_rule(p))  // bitwise_or
            &&
            (for_if_clauses_var = for_if_clauses_rule(p))  // for_if_clauses
...
invalid_double_type_comments_rule(Parser *p)
{
    ...
    { // TYPE_COMMENT NEWLINE TYPE_COMMENT NEWLINE INDENT
        ...
        if (
            ...
            (newline_var = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (type_comment_var_1 = _Mys_PyPegen_expect_token(p, TYPE_COMMENT))  // token='TYPE_COMMENT'
            &&
            (newline_var_1 = _Mys_PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (indent_var = _Mys_PyPegen_expect_token(p, INDENT))  // token='INDENT'
        )
        {
...
// invalid_for_target: 'for' star_expressions
static void *
invalid_for_target_rule(Parser *p)
{
    ...
    void * _res = NULL;
    int _mark = p->mark;
    { // 'for' star_expressions
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> invalid_for_target[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'for' star_expressions"));
        Token * _keyword;
        void *_opt_var;
        UNUSED(_opt_var); // Silence compiler warnings
        expr_ty a;
        ...
        D(fprintf(stderr, "%*c%s invalid_for_target[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'for' star_expressions"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_1_rule(Parser *p)
{
    ...
    asdl_seq *_seq = (asdl_seq*)_Mys_Py_asdl_generic_seq_new(_n, p->arena);
    if (!_seq) {
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_1_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_2_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_2_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_4_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_4_type, _seq);
    D(p->level--);
    return _seq;
}
...
_gather_3_rule(Parser *p)
{
    ...
    { // expression _loop0_4
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_seq_insert_in_front(p, elem, seq);
            goto done;
        }
        p->mark = _mark;
...
_loop0_6_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_6_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_8_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_8_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_10_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_10_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_11_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_11_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_13_rule(Parser *p)
{
    ...
    { // ';' small_stmt
        ...
        stmt_ty elem;
        while (
            (_literal = _Mys_PyPegen_expect_token(p, 13))  // token=';'
            &&
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_13_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_15_rule(Parser *p)
{
    ...
    { // 'func'
        ...
        D(fprintf(stderr, "%*c%s _tmp_15[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'func'"));
    }
    { // 'macro'
        if (p->error_indicator) {
            D(p->level--);
...
_loop1_22_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_22_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_26_rule(Parser *p)
{
    ...
    { // ',' NAME
        ...
        while (
            (_literal = _Mys_PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _Mys_PyPegen_name_token(p))  // NAME
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_26_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_28_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_28_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_31_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_31_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_32_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_32_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_34_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_34_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_35_rule(Parser *p)
{
    ...
    { // 'as' NAME
        ...
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 520))  // token='as'
            &&
            (z = _Mys_PyPegen_name_token(p))  // NAME
        )
        {
...
_loop0_37_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_37_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_48_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_48_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_50_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_50_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_52_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_52_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_57_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_57_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_60_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_60_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_63_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_63_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_65_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_65_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_67_rule(Parser *p)
{
    ...
    { // '->' expression
        ...
        expr_ty z;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 51))  // token='->'
            &&
            (z = expression_rule(p))  // expression
        )
        {
...
_tmp_69_rule(Parser *p)
{
    ...
    { // NEWLINE INDENT
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_dummy_name(p, newline_var, indent_var);
            goto done;
        }
        p->mark = _mark;
...
_loop0_70_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_70_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_71_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_71_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_72_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_72_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_73_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_73_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_74_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_74_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_75_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_75_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_76_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_76_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_77_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_77_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_78_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_78_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_79_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_79_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_80_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_80_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_81_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_81_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_82_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_82_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_83_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_83_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_84_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_84_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_87_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_87_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_88_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_88_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_90_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_90_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_91_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_91_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_92_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_92_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_93_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_93_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_94_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_94_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_95_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_95_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_96_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_96_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_97_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_97_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_98_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_98_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_99_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_99_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_100_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_100_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_101_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_101_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_102_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_102_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_103_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_103_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_104_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_104_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_105_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_105_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_106_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_106_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_107_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_107_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_108_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_108_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_109_rule(Parser *p)
{
    ...
    { // '!='
        ...
        Token * tok;
        if (
            (tok = _Mys_PyPegen_expect_token(p, 28))  // token='!='
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_109[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'!='"));
            _res = _Mys_PyPegen_check_barry_as_flufl ( p , tok ) ? NULL : tok;
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
_loop0_111_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_111_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_116_rule(Parser *p)
{
    ...
    { // STRING
        ...
        expr_ty string_var;
        while (
            (string_var = _Mys_PyPegen_string_token(p))  // STRING
        )
        {
            _res = string_var;
            if (_n == _children_capacity) {
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_116_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_117_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions?
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_seq_insert_in_front ( p , y , z );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
_loop0_120_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_120_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_121_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_121_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_123_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_123_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_125_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_125_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_128_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_128_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_130_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_130_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_132_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_132_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_134_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_134_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_135_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_135_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_137_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_137_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_138_rule(Parser *p)
{
    ...
    { // !'*' star_target
        ...
        if (
            _Mys_PyPegen_lookahead_with_int(0, _Mys_PyPegen_expect_token, p, 16)  // token='*'
            &&
...
_loop0_140_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_140_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_142_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_142_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_143_rule(Parser *p)
{
    ...
    { // expression for_if_clauses
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_143[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses"));
            _res = _Mys_PyPegen_dummy_name(p, expression_var, for_if_clauses_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_143[%d-%d]: %s failed!\n", p->level, ' ',
...
_loop0_144_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_144_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_145_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_145_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_146_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_146_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_149_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_149_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_151_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop0_151_type, _seq);
    D(p->level--);
    return _seq;
}
...
_tmp_153_rule(Parser *p)
{
    ...
    { // ')'
        ...
        Token * _literal;
        if (
            (_literal = _Mys_PyPegen_expect_token(p, 8))  // token=')'
        )
        {
    ...
    { // ',' (')' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_153[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (')' | '**')"));
            _res = _Mys_PyPegen_dummy_name(p, _literal, _tmp_171_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_153[%d-%d]: %s failed!\n", p->level, ' ',
...
_tmp_154_rule(Parser *p)
{
    ...
    { // ',' (':' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_154[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (':' | '**')"));
            _res = _Mys_PyPegen_dummy_name(p, _literal, _tmp_172_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_154[%d-%d]: %s failed!\n", p->level, ' ',
...
_tmp_161_rule(Parser *p)
{
    ...
    { // 'or' conjunction
        ...
        expr_ty c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 531))  // token='or'
            &&
...
_tmp_162_rule(Parser *p)
{
    ...
    { // 'and' inversion
        ...
        expr_ty c;
        if (
            (_keyword = _Mys_PyPegen_expect_token(p, 532))  // token='and'
            &&
...
_tmp_167_rule(Parser *p)
{
    ...
    { // star_targets '='
        ...
        )
        {
            ...
            _res = _Mys_PyPegen_dummy_name(p, star_targets_var, _literal);
            goto done;
        }
        p->mark = _mark;
...
_loop1_169_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_169_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_170_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) Mys_asdl_seq_SET_UNTYPED(_seq, i, _children[i]);
    PyMem_Free(_children);
    _Mys_PyPegen_insert_memo(p, _start_mark, _loop1_170_type, _seq);
    D(p->level--);
    return _seq;
}
