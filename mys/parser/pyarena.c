...
Mys_PyArena_New()
{
    Mys_PyArena* arena = (Mys_PyArena *)PyMem_Malloc(sizeof(Mys_PyArena));
    if (!arena)
        return (Mys_PyArena*)PyErr_NoMemory();
...
void
Mys_PyArena_Free(Mys_PyArena *arena)
{
    assert(arena);
#if defined(Py_DEBUG)
    /*
...
void *
Mys_PyArena_Malloc(Mys_PyArena *arena, size_t size)
{
...
int
Mys_PyArena_AddPyObject(Mys_PyArena *arena, PyObject *obj)
{
